...
At this point, on GUI go to Installed Operators and wait until the _Open Data Hub_ and _Jenkins_ operators are installed as shown:
...
If you forking the repo, you'll need toi update the docs (all .md files in the this directory) and replace all instaneces of https://github.com/**masoodfaisal**/ml-workshop with https://github.com/**your repo**/ml-workshop
